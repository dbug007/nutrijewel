...
const ProductsPage = () => {
  ...
  const handleBuyNow = (productName) => {
    const message = `Hi! I'm interested in buying ${productName}. Can you help me with the details?`;
    const whatsappUrl = `https://wa.me/919876543210?text=${encodeURIComponent(message)}`;
    window.open(whatsappUrl, '_blank');
  };
      ...
      <section className="products-header">
        <div className="products-container">
          <h1 className="products-title">
            Our <span className="products-title-green">Premium Products</span>
          </h1>
          <p className="products-subtitle">
            Handcrafted with love, made with the finest natural ingredients for your health and happiness
          </p>
      ...
      <section className="products-cta">
        <div className="products-container">
          <div className="cta-content">
            ...
            <button 
              className="cta-btn"
              onClick={() => handleBuyNow("custom product consultation")}
            >
              Get Custom Products
            </button>
          </div>
