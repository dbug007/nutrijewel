...
const TermsAndConditions = () => {
  return (
    <PolicyLayout title="Terms & Conditions" lastUpdated="December 20, 2025">
      ...
      <div className="policy-highlight business-info-box">
        ...
        <div className="business-details">
          ...
          <p><strong>Email:</strong> hello@nutrijewel.com</p>
        </div>
      </div>
      ...
      <div className="policy-section">
        ...
        <p>
          ...
          regulations, privacy policy and Terms of Use for access or usage of domain name <strong>www.nutrijewel.com</strong> ('Website'), 
          including the related mobile site and mobile application (hereinafter referred to as 'Platform').
        </p>
        <p>
          The Platform is owned by <strong>NutriJewel</strong>, a company incorporated under the Companies Act, 1956 with 
          its registered office at Pune, India (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
        </p>
      </div>
      ...
      <div className="policy-section">
        ...
        <p>
          ...
          conflict with these Terms of Use are expressly rejected by the Platform Owner and shall be of no force or effect.
        </p>
        <div className="policy-highlight">
          <strong>Important:</strong> These Terms of Use can be modified at any time without assigning any reason. 
        ...
        <p>
          <strong>ACCESSING, BROWSING OR OTHERWISE USING THE PLATFORM INDICATES YOUR AGREEMENT TO ALL THE 
          TERMS AND CONDITIONS UNDER THESE TERMS OF USE, SO PLEASE READ THE TERMS OF USE CAREFULLY BEFORE PROCEEDING.</strong>
        </p>
      </div>
      ...
      <div className="policy-section">
        ...
        <p>
          ...
          jurisdiction of the courts in <strong>Pune, Maharashtra</strong>.
        </p>
      </div>
