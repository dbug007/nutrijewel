...
const PrivacyPolicy = () => {
  return (
    <PolicyLayout title="Privacy Policy" lastUpdated="December 17, 2025">
      
      <div className="policy-section">
        <h2>Introduction</h2>
        <p>
          This Privacy Policy describes how <strong>NutriJewel</strong> and its affiliates (collectively "NutriJewel, we, our, us")
          collect, use, share, protect or otherwise process your information/personal data through our website 
          <strong> www.nutrijewel.com</strong> (hereinafter referred to as Platform). Please note that you may be able to browse
        ...
        <p>
          ...
          product/service offered on the Platform, you expressly agree to be bound by the terms and conditions of this 
          Privacy Policy, the Terms of Use and the applicable service/product terms and conditions, and agree to be 
          governed by the laws of India including but not limited to the laws applicable to data protection and privacy.
        </p>
        <div className="policy-highlight">
          <strong>Important:</strong> If you do not agree please do not use or access our Platform.
        </div>
      </div>
      ...
      <div className="policy-section">
        ...
        <ul>
          <li>Personal data/information provided during sign-up/registration such as name, date of birth, address, 
              telephone/mobile number, email ID</li>
          <li>Information shared as proof of identity or address</li>
          <li>Bank account or credit/debit card or other payment instrument information</li>
          <li>Biometric information such as your facial features or physiological information (when you opt for 
              certain features available on the Platform)</li>
          <li>Transaction-related information on our Platform and third-party business partner platforms</li>
          <li>Your behavior, preferences, and other information that you choose to provide on our Platform</li>
        </ul>
        <p>
          Some of the sensitive personal data may be collected with your consent, in accordance with applicable law(s). 
          You always have the option to not provide information, by choosing not to use a particular service or feature 
          on the Platform.
        </p>
        <div className="policy-highlight">
          <strong>Security Alert:</strong> If you receive an email or call from a person/association claiming to be 
          NutriJewel seeking personal data like debit/credit card PIN, net-banking or mobile banking password, we 
      ...
      <div className="policy-section">
        ...
        <p>
          ...
          to you, we will provide you the ability to opt-out of such uses. We use your personal data to:
        </p>
        <ul>
      ...
      <div className="policy-section">
        ...
        <ul>
          ...
          <li>Third-party reward programs and other payment providers opted by you</li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>Prevent, detect, mitigate, and investigate fraudulent or illegal activities</li>
        </ul>
        <p>
          We may disclose personal and sensitive personal data to government agencies or other authorized law 
          enforcement agencies if required to do so by law or in the good faith belief that such disclosure is 
          reasonably necessary to respond to subpoenas, court orders, or other legal process.
        </p>
      </div>
      ...
      <div className="policy-section">
        <h2>Data Security</h2>
        <p>
          To protect your personal data from unauthorized access or disclosure, loss or misuse we adopt reasonable 
        ...
        <p>
          However, the transmission of information is not completely secure for reasons beyond our control. By using 
          the Platform, the users accept the security implications of data transmission over the internet and the 
          World Wide Web which cannot always be guaranteed as completely secure, and therefore, there would always 
          remain certain inherent risks regarding use of the Platform.
        </p>
        <div className="policy-highlight">
          <strong>Your Responsibility:</strong> Users are responsible for ensuring the protection of login and 
      ...
      <div className="policy-section">
        ...
        <p>
          We may in event of any pending grievance, claims, pending shipments or any other services refuse or delay 
          deletion of the account. Once the account is deleted, you will lose access to the account.
        </p>
        <p>
          We retain your personal data information for a period no longer than is required for the purpose for which 
          it was collected or as required under any applicable law. However, we may retain data related to you if we 
          believe it may be necessary to prevent fraud or future abuse or for other legitimate purposes. We may continue 
          to retain your data in anonymized form for analytical and research purposes.
        </p>
      </div>
      ...
      <div className="policy-section">
        ...
        <p>
          ...
          at the contact information provided below. Please mention <strong>"Withdrawal of consent for processing personal data"</strong> in 
          your subject line of your communication.
        </p>
        <p>
          However, please note that your withdrawal of consent will not be retrospective and will be in accordance with 
          the Terms of Use, this Privacy Policy, and applicable laws. In the event you withdraw consent given to us under 
          this Privacy Policy, we reserve the right to restrict or deny the provision of our services for which we consider 
      ...
      <div className="policy-contact">
        <h3>Contact Us / Grievance Officer</h3>
        <p><strong>NutriJewel</strong></p>
        <p>Pune, India</p>
