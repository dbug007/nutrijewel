        ...
        <div className="aboutpage-container">
          <div className="aboutpage-section-header">
            ...
            <p className="aboutpage-section-subtitle">
              A brand story sparked by passion and purpose
            </p>
          </div>
            ...
            <div className="aboutpage-story-timeline">
              <div className="aboutpage-timeline-item">
                ...
                <div className="aboutpage-timeline-content">
                  ...
                  <p className="aboutpage-timeline-text">
                    As a child, my dreams always revolved around food. Whether it was owning a cafe,
                    sharing recipes, conducting cooking workshops, or launching a healthy snacking
                    brand, I knew my journey would be woven around the joy of cooking and feeding
                    others. Food has always been my passion, my comfort, and my creative outlet.
                  </p>
                </div>
              </div>
              ...
              <div className="aboutpage-timeline-item">
                ...
                <div className="aboutpage-timeline-content">
                  ...
                  <p className="aboutpage-timeline-text">
                    But as I grew, I noticed a gap, especially in India. The resources and
                    ingredients I craved were rare, often inaccessible, or simply did not exist.
                    Every trip to the market was a reminder: why should not healthy, delicious
                    snacks be easy to find at home? This pain point became the seed for NJ.
                  </p>
                </div>
              </div>
              ...
              <div className="aboutpage-timeline-item">
                ...
                <div className="aboutpage-timeline-content">
                  ...
                  <p className="aboutpage-timeline-text">
                    Leaving a stable corporate job was not easy. But the call to create something
                    meaningful was louder. Before I took the leap, I dove deep into learning the
                    technicalities of food, nutrition, and product development, and decided to
                    pursue a Masters in Nutritional Sciences and Dietetics.
                  </p>
                </div>
              </div>
              ...
              <div className="aboutpage-timeline-item">
                ...
                <div className="aboutpage-timeline-content">
                  ...
                  <p className="aboutpage-timeline-text">
                    NutriJewel was born in 2023, not just as a brand, but as a promise to make
                    healthy snacking accessible, exciting, and truly Indian. Every product is a
                    reflection of my journey: the challenges, the learning, and the unwavering
                    hope that food can bring people together and make lives better.
                  </p>
                </div>
              </div>
              ...
              <div className="aboutpage-timeline-item">
                ...
                <div className="aboutpage-timeline-content">
                  ...
                  <p className="aboutpage-timeline-text">
                    Today, NJ stands for more than just snacks. It is about bringing joy back to
                    eating, making health a habit, and proving that passion, when combined with
                    purpose, can nourish a nation. If you have ever struggled to find the right
                    snack, know that NutriJewel was created for you, by someone who has been there.
                  </p>
                </div>
              </div>
              ...
              <div className="aboutpage-timeline-item">
                ...
                <div className="aboutpage-timeline-content">
                  <h3 className="aboutpage-timeline-title">Join The Journey</h3>
                  <p className="aboutpage-timeline-text">
                    Join us on this journey. Let us make healthy snacking a celebration, every
                    single day.
                  </p>
                </div>
              </div>
                ...
                <div className="aboutpage-testimonial-header">
                  <div className="aboutpage-stars">
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <Star key={i} size={16} className="aboutpage-star-filled" fill="currentColor" />
                    ))}
                  </div>
                </div>
        ...
        <div className="aboutpage-container">
          <div className="aboutpage-stats-grid">
            <div className="aboutpage-stat-card">
              <div className="aboutpage-stat-number">1000+</div>
